...
const LABELS: Record<string, string> = {
  ...
  CLIMATIZATION: "Climatização", ELECTRICAL: "Elétrica", IT: "T.I.", PREVENTIVE: "Manutenção preventiva",
  CORRECTIVE: "Manutenção corretiva", INSTALLATION: "Instalação", TECHNICAL_VISIT: "Visita técnica",
  BUDGET: "Orçamento", MEETING: "Reunião", TECH_SUPPORT: "Suporte de T.I.",
  ...
  PACKAGE: "Pacote", TOOL: "Ferramenta", VEHICLE: "Veículo", COMPUTER: "Computador", SERVER: "Servidor", PRINTER: "Impressora", NETWORK_DEVICE: "Equipamento de rede",
  ...
  CASH: "Dinheiro", ENTRY_BALANCE: "Entrada + saldo", INSTALLMENTS: "Parcelado",
  MILESTONES: "Por etapas", CUSTOM: "Personalizado", CHECKING: "Conta corrente",
  SAVINGS: "Poupança", DIGITAL_WALLET: "Carteira digital", INVESTMENT: "Investimento",
...
export function paymentConditionLabel(value?: string | null): string {
