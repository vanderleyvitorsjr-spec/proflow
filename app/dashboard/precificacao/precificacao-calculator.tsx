...
type PrecificacaoCalculatorProps = {
  ...
  onChange: (field: keyof PricingCalculationInput, value: number) => void;
};
...
export function PrecificacaoCalculator({
  ...
  const laborCost = values.laborHours * values.laborHourlyCost * values.technicians;

  const displacementCost = values.distanceKm * values.costPerKm;
        ...
        <CardHeader className="border-b border-border px-4 py-3">
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <CardTitle className="mt-1 text-lg">Calculadora de preço</CardTitle>
            </div>
        ...
        <CardContent className="space-y-4 p-4">
          <div>
            <div className="mb-4 flex items-center gap-2">
              <Wrench className="h-4 w-4 text-sky-600" aria-hidden="true" />
              <h3 className="text-sm font-bold text-foreground">Custos diretos</h3>
            </div>
            ...
            <div className="grid gap-2.5 sm:grid-cols-2 xl:grid-cols-3">
              ...
              <NumericField
                ...
                suffix="h"
                onChange={(value) => onChange("laborHours", value)}
              />
              ...
              <NumericField
                ...
                suffix="R$"
                onChange={(value) => onChange("laborHourlyCost", value)}
              />

              <NumericField
                label="Quantidade de técnicos"
                value={values.technicians}
                onChange={(value) => onChange("technicians", value)}
              />
              ...
              <NumericField
                ...
                suffix="R$"
                onChange={(value) => onChange("equipmentCost", value)}
              />
              ...
              <NumericField
                ...
                suffix="R$"
                onChange={(value) => onChange("thirdPartyCost", value)}
              />
            </div>
          </div>
          ...
          <div className="border-t border-border pt-6">
            <div className="mb-4 flex items-center gap-2">
              <Car className="h-4 w-4 text-violet-600" aria-hidden="true" />
            ...
            <div className="grid gap-2.5 sm:grid-cols-2 xl:grid-cols-3">
              ...
              <NumericField
                ...
                suffix="R$"
                onChange={(value) => onChange("costPerKm", value)}
              />
              ...
              <NumericField
                ...
                suffix="R$"
                onChange={(value) => onChange("tollCost", value)}
              />
              ...
              <NumericField
                ...
                suffix="R$"
                onChange={(value) => onChange("accommodationCost", value)}
              />
              ...
              <NumericField
                ...
                suffix="R$"
                onChange={(value) => onChange("foodCost", value)}
              />
            </div>
          </div>
          ...
          <div className="border-t border-border pt-6">
            ...
            <div className="grid gap-2.5 sm:grid-cols-2 xl:grid-cols-4">
              ...
              <NumericField
                ...
                suffix="%"
                onChange={(value) => onChange("marginRate", value)}
              />
            ...
            <div className="relative">
              ...
              <div className="mt-6 grid grid-cols-2 gap-3">
                <div className="rounded-xl border border-white/10 bg-white/[0.06] p-3">
                  <p className="text-[0.65rem] text-slate-400">Lucro estimado</p>
                ...
                <div className="rounded-xl border border-white/10 bg-white/[0.06] p-3">
                  <p className="text-[0.65rem] text-slate-400">Margem efetiva</p>
                  <p className="mt-1 text-sm font-bold">
        ...
        <Card className="rounded-[var(--radius-card)] border-border bg-card shadow-xs">
          ...
          <CardContent className="space-y-2 p-4">
            <div className="flex items-center justify-between gap-3 text-sm">
              ...
              <strong className="text-foreground">{formatCurrency(laborCost)}</strong>
            </div>
            ...
            <div className="flex items-center justify-between gap-3 text-sm">
              ...
              <strong className="text-foreground">{formatCurrency(directCost)}</strong>
            </div>
            ...
            <div className="flex items-center justify-between gap-3 text-sm">
              <span className="text-muted-foreground">Margem adicionada</span>
