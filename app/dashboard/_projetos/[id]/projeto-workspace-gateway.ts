...
import { listAgendaEventsAction } from "@/app/dashboard/_agenda/agenda-actions";
...
import { getOrdemAction, updateOrdemChecklistAction } from "@/app/dashboard/_ordens/ordens-actions";
import type { OrdemRecord } from "@/app/dashboard/_ordens/ordens-types";
import type { OrdemChecklistItem } from "@/app/dashboard/_ordens/ordens-types";
import { listPricingReportAction } from "@/app/dashboard/precificacao/precificacao-actions";
import { listStockAction } from "@/app/dashboard/_estoque/estoque-actions";
import { loadOperationalCenterSnapshot } from "@/app/dashboard/_central-operacional/central-operacional-gateway";
...
import type { EquipmentAsset, MaintenanceRecord } from "@/app/dashboard/_equipamentos/equipamentos-types";
import type { FinancialTransaction } from "@/app/dashboard/financeiro/financeiro-types";
import type { StockMovement, StockReservation, StockSnapshot } from "@/app/dashboard/_estoque/estoque-types";
