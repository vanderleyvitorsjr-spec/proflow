...
export const linkEquipmentServiceOrderAction = (assetId: string, orderId: string, purpose?: string) =>
...
export const createEquipmentMaintenanceAction = (assetId: string, input: MaintenanceFormValues) =>
  action(() => service.createMaintenance(assetId, input));
export const updateEquipmentMaintenanceAction = (id: string, input: MaintenanceFormValues) =>
...
export const updateEquipmentWarrantyAction = (assetId: string, input: WarrantyFormValues) =>
...
export const createEquipmentAcquisitionFinancialAction = (assetId: string, input: EquipmentFinancialFormValues, additionalSequence?: number) =>
  action(() => service.createAcquisitionFinancial(assetId, input, additionalSequence));
export const listEquipmentFinancialAccountsAction = () => action(() => service.listFinancialAccounts());
export const createEquipmentMaintenanceFinancialAction = (maintenanceId: string, input: EquipmentFinancialFormValues, additionalSequence?: number) =>
  action(() => service.createMaintenanceFinancial(maintenanceId, input, additionalSequence));
export const getEquipmentFinancialSummaryAction = (assetId: string) =>
  action(() => service.getEquipmentFinancialSummary(assetId));
export const reviewEquipmentFinancialAction = (assetId: string, maintenanceId: string | undefined, notes: string, updateSnapshot: boolean) =>
  action(() => service.reviewEquipmentFinancial(assetId, maintenanceId, notes, updateSnapshot));
export const cancelEquipmentFinancialBalanceAction = (assetId: string, transactionId: string, maintenanceId?: string) =>
  action(() => service.cancelEquipmentFinancialBalance(assetId, transactionId, maintenanceId));
