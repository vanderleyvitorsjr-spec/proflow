...
export type OrdemHistory = { id: string; type: "CREATED" | "UPDATED" | "STATUS" | "PRIORITY" | "TECHNICIAN" | "SCHEDULE" | "VALUE" | "CHECKLIST" | "CANCELED" | "ARCHIVED"; description: string; createdAt: string };
export type OrdemRecord = {
  ...
  createdAt: string; updatedAt: string; canceledAt?: string; cancellationReason?: string; archivedAt?: string; history: OrdemHistory[];
};
