...
export const ordemSchema = z.object({
  ...
  description: z.string().trim().min(3, "Descreva o problema relatado ou o serviço solicitado."), category: z.enum(["CLIMATIZATION", "ELECTRICAL", "IT", "PREVENTIVE", "CORRECTIVE", "INSTALLATION"]),
