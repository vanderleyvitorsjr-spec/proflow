...
import { BrazilianPhoneInput, CpfCnpjInput, ProperNameInput } from "@/components/ui/br-masked-inputs";
...
function ConversionForm({ lead, onDone }: { lead: CrmLeadRecord; onDone: (updated: CrmLeadRecord) => void }) {
  ...
  const { register, control, handleSubmit, formState: { errors } } = useForm<ClientFormInput, unknown, ClientFormValues>({ resolver: zodResolver(clientSchema), defaultValues: defaultsFromLead(lead) });
